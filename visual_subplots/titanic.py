...
def plot_age_vs_survival(ax, data):
    ...
    survivors = [
        len(children['survived']),
        len(adults['survived']),
        len(elderly['survived'])
    ]
    deceased = [
        len(children['deceased']),
        len(adults['deceased']),
        len(elderly['deceased'])
    ]
...
def plot_all_vs_survival(ax, data):
    ...
    for index in range(len(data['age'])):
        ...
        if (age < 18):
            ...
            elif (data['sex'][index] == 'male'
                  and not data['survived'][index]):
    ...
    male_survivors = [
        len(children['male']['survived']),
        len(adults['male']['survived']),
        len(elderly['male']['survived'])
    ]
    female_survivors = [
        len(children['female']['survived']),
        len(adults['female']['survived']),
